...
Thanks Redirect for WooCommerce allows adding Thank You Page or Thank You URL for WooCommerce Products for your Customers, now supports Order Details on Thank You Page.
...
1- <a href="https://bit.ly/2RxRkT5">Thanks Redirect PRO</a> allows all the functionalities of Thanks Redirect but for Wordpress Multisite too.
...
= 3.0 = 
Major update - Various bug fixes and features added. Please check changelog 
= 2.4.1 =
Added support for Order Number or Order ID on Order details on Thank You Page.
